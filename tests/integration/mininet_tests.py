    ...
    CONFIG = """
        ...
        interfaces:
            %(port_1)d:
                ...
                dot1x_dyn_acl: {PORT_DOT1X_DYN_ACL}
            %(port_2)d:
                name: b2
                description: "b2"
                native_vlan: 100
...
class Faucet8021XCustomACLLogin1Test(Faucet8021XCustomACLLoginTest):
    """Multiple logins using custom ACL tests"""
...
class Faucet8021XCustomACLLogin2Test(Faucet8021XCustomACLLogin1Test):
    """Ensure that 8021X Port ACLs Work before and after Logout"""
    DOT1X_EXPECTED_EVENTS = [
        {'ENABLED': {}},
        {'PORT_UP': {'port': 'port_1', 'port_type': 'supplicant'}},
...
class Faucet8021XSimultaneousLoginTest(Faucet8021XBaseTest):
    DOT1X_EXPECTED_EVENTS = [
        {'ENABLED': {}},
        {'PORT_UP': {'port': 'port_1', 'port_type': 'supplicant'}},
        {'PORT_UP': {'port': 'port_2', 'port_type': 'supplicant'}},
    ...
    def test_untagged(self):
        ...
        self.wait_for_eap_success(self.eapol2_host, self.get_wpa_ctrl_path(self.eapol2_host))
        self.terminate_wpasupplicant(self.eapol2_host)
